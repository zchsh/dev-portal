...
Largely duplicative of the implementation in react-tabs:

https://github.com/hashicorp/react-components/tree/main/packages/tabs/partials/tooltip

This could likely be elevated as a `react-component`.
Or perhaps the design systems team will provide an equivalent package.
